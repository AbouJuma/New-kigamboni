...
(function() {
    ...
    div.innerHTML = `
        ...
        <button id="send-display" style="padding:5px 10px;background:#4CAF50;color:#fff;border:none;border-radius:3px;cursor:pointer;">Send</button>
        <div style="margin-top:5px;">
            <label><input type="checkbox" id="auto-send" checked> Auto-send</label>
        </div>
        <div id="display-status" style="font-size:12px;color:#666;margin-top:5px;">Ready</div>
        <div id="display-source" style="font-size:11px;color:#999;"></div>
    `;
