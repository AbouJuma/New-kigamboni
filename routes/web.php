...
Route::get('/companie/view', 'CompanyController@index');
...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/license-test', 'LicenseController@test');

    // License Management Routes (accessible without authentication for support purposes)
    ...
    Route::get('/license/status', 'LicenseController@status')->name('license.status');
});

Route::group(['middleware' => ['web', 'auth:web', 'Is_Active', 'license.check', 'license.notification']], function () {
