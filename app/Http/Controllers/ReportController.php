...
class ReportController extends BaseController
{
    ...
    public function stock_Report(request $request)
    {
        ...
        foreach ($products as $product) {
            ...
            if($product->type != 'is_service'){
                ...
                ->sum('qte');
                $item['totalsum'] = $product->cost * $current_stock;
    ...
    public function product_sales_report(request $request)
    {
        ...
        ->where(function ($query) use ($request) {
         ...
         foreach ($sale_details as $detail) {
             ...
             $item['total'] = $detail->total;
             $item['price'] = $detail->price;
             $item['cost'] = $detail['product']['cost'];
             $item['profit'] = $detail->total - $detail['product']['cost']* $detail->quantity;
             $item['product_name'] = $product_name;
             $item['unit_sale'] = $unit?$unit->ShortName:'';
    ...
    public function expenses_report(request $request)
    {
        ...
        ->select(
            ...
            DB::raw('expenses.details as exp_details'),
              DB::raw('expenses.date as dates'),
        ...
        foreach ($expenses as $expense) {
            ...
            $item['exp_details'] = $expense->exp_details;
            $item['dates'] = $expense->dates;
